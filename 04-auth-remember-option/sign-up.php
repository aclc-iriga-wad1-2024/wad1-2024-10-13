...
if(isset($_POST['sign-up']))
{
    ...
    if($error == '') {
        ...
        $stmt->execute();
        // if insert is successful, sign-in the user using username and hashed password (not remembered) and redirect to homepage
        if($stmt->affected_rows > 0) {
            $_SESSION['example4_username'] = $username;
            $_SESSION['example4_password'] = $password_hashed;
            header('location: index.php');
        }
