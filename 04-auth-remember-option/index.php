...
if(isset($_POST['shout-out']) && isset($_SESSION['example4_username']) && isset($_SESSION['example4_password']))
{
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-2">
                            ...
                            <select name="user_selected" class="form-control">
                                ...
                                <?php
                                foreach ($users as $u) {
                                    if($u['username'] != $_SESSION['example4_username']) { // except the session owner
                                ?>
