...
if(isset($_POST['shout-out']) && isset($_COOKIE['example3_username']) && isset($_COOKIE['example3_password']))
{
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-2">
                            ...
                            <select name="user_selected" class="form-control">
                                ...
                                <?php
                                foreach ($users as $u) {
                                    if($u['username'] != $_COOKIE['example3_username']) { // except the cookie owner
                                ?>
