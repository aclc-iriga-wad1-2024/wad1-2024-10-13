    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <?php if(isset($_COOKIE['example3_username']) && isset($_COOKIE['example3_password'])) { ?>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link<?= ($view === 'profile' && isset($profile) && $profile['username'] == $_COOKIE['example3_username'] && $profile['password'] == $_COOKIE['example3_password']) ? ' active' : '' ?>" href="profile.php">
