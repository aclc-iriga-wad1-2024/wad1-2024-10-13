        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <?php if(isset($_SESSION['example2_username']) && isset($_SESSION['example2_password'])) { ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link<?= ($view === 'profile' && isset($profile) && $profile['username'] == $_SESSION['example2_username'] && $profile['password'] == $_SESSION['example2_password']) ? ' active' : '' ?>" href="profile.php">
